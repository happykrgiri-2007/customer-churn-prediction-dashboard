...
The dashboard can be deployed using **Streamlit Community Cloud** from this GitHub repository.

### Deployment Configuration

```text
Repository: happykrgiri-2007/customer-churn-prediction-dashboard
Branch: main
Main file: app.py
```
...
The Customer Churn Intelligence Dashboard provides an interactive approach to understanding telecom customer churn.

The analysis highlights contract type, customer tenure, payment method, internet service, technical support, and monthly charges as important dimensions for understanding churn behavior.

The dashboard helps identify high-risk customer segments and provides practical recommendations that can support customer retention strategies.

By using data-driven segmentation and targeted retention actions, telecom businesses can better understand customer behavior and take proactive steps to reduce customer attrition.
...
**Task:** Task 2  
**Domain:** Data Science / Customer Analytics  
**Organization:** Digital Kuppam  
